...
def predict():
    ...
    if user_palette == "autumn":
        response['PalImg'] = "AutumnPal.png"
        response['PalDesc'] = "Palet musim gugur menghadirkan kehangatan dan kedalaman dengan warna-warna seperti coklat tua, oranye hangat, dan hijau zaitun. Warna-warna ini sempurna untuk pernikahan yang memancarkan keintiman dan kenyamanan dalam suasana alami dan hangat."
        response['Colors'] = [
        ...
        response['PalImg'] = "SpringPal.png"
        response['PalDesc'] = "Palet musim semi membawa palet cerah dan segar, dengan warna biru cerah, hijau muda, dan merah muda. Ini mencerminkan kebangkitan dan harapan baru, cocok untuk pernikahan yang penuh keceriaan di taman berbunga."
        response['Colors'] = [
        ...
        response['PalImg'] = "SummerPal.png"
        response['PalDesc'] = "Palet musim panas menampilkan warna-warna yang cerah dan ceria seperti biru laut, ungu muda, dan merah jambu. Ideal untuk pernikahan pantai atau luar ruangan yang menyenangkan dan riang, mencerminkan kebebasan dan keceriaan musim panas."
        response['Colors'] = [
        ...
        response['PalImg'] = "WinterPal.png"
        response['PalDesc'] = "Musim dingin membawa palet yang tajam dan dramatis dengan warna hitam, putih, dan merah tua. Cocok untuk pernikahan dalam ruangan yang elegan dan mewah, menciptakan suasana berkelas dan memikat yang penuh dengan kemewahan."
        response['Colors'] = [
        ...
        response['PalDesc'] = "Invalid palette"
